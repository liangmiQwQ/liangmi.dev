        ...
        <div class="md:col-span-7">
          <div class="grid gap-6">
            ...
            <div class="max-w-[64ch]">
              <div class="inline-flex items-center gap-2 font-mono text-12px tracking-[0.14em] text-amber-600 dark:text-amber-500 uppercase">
            ...
            <div class="rounded-2xl border border-stone-200 p-5 dark:border-stone-800">
              ...
              <div class="mt-5 grid grid-cols-2 gap-4">
                <div class="rounded-xl border border-stone-200 bg-stone-50 p-4 dark:border-stone-800 dark:bg-stone-900/50">
                  <div class="font-serif text-[clamp(28px,4.6vw,44px)] leading-[1] -tracking-[0.05em] text-amber-700 dark:text-amber-400">
